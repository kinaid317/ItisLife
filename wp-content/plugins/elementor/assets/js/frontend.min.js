        ...
        (this.elementsHandlers = {
          ...
          elementorFrontendConfig.experimentalFeatures.container &&
            ...
            (this.elementsHandlers["floating-bars-var-1.default"] = () =>
              Promise.resolve().then(n.bind(n, 7712))));
      ...
      class BackgroundVideo extends elementorModules.frontend.handlers.Base {
        ...
        calcVideosSize(e) {
          ...
          const n = this.elements.$backgroundVideoContainer.outerWidth(),
            ...
            i = s[0] / s[1],
            r = n / o > i;
          return { width: r ? n : o * i, height: r ? n / i : o };
        }
        changeVideoSize() {
    ...
    6866: (e, t) => {
      ...
      const n = elementorFrontendConfig.urls.assets,
        ...
        i = elementorFrontendConfig.experimentalFeatures.e_swiper_latest
          ? `${n}lib/swiper/v8/swiper${o}.js?ver=8.4.5`
          : `${n}lib/swiper/swiper${o}.js?ver=5.3.6`,
        r = elementorFrontendConfig.experimentalFeatures.e_swiper_latest
          ? `${n}lib/swiper/v8/css/swiper${o}.css?ver=8.4.5`
          : `${n}lib/swiper/css/swiper${o}.css?ver=5.3.6`;
      AssetsLoader.assets = {
        script: {
    ...
    9469: (e) => {
      e.exports = function () {
        ...
        function _addHook(e, t, o, s, i) {
          var r = { callback: o, priority: s, context: i },
            a = n[e][t];
          if (a) {
            var l = !1;
            if (
        ...
        function _runHook(e, t, o) {
          ...
          else for (s = 0; s < i; s++) r[s].callback.apply(r[s].context, o);
          ...
          (e = {
            ...
            addFilter: function addFilter(t, n, o, s) {
              return (
                "string" == typeof t &&
                  "function" == typeof n &&
                  _addHook("filters", t, n, (o = parseInt(o || 10, 10)), s),
                e
              );
            },
            ...
            addAction: function addAction(t, n, o, s) {
              return (
                "string" == typeof t &&
                  "function" == typeof n &&
                  _addHook("actions", t, n, (o = parseInt(o || 10, 10)), s),
                e
              );
            },
          }),
      ...
      var o = n(1695),
        ...
        y = function DOMException() {
          ...
          var e = arguments.length,
            ...
            s = v(t);
          return (
            (s.name = f), a(o, "stack", r(1, m(s.stack, 1))), c(o, this, y), o
          );
        },
