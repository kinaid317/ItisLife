/*preloader*/ (function (a) {
  ...
  a(document).ready(function () {
    var b,
      ...
      e = "";
    if (
      a(".tp-4-preload-topleft").length ||
      a(".tp-4-preload-topright").length ||
      a(".tp-4-preload-bottomleft").length ||
      a(".tp-4-preload-bottomright").length
    ) {
    ...
    (a(".tp-4-preload-topleft").length ||
      ...
      a(".tp-4-preload-bottomleft").length ||
      a(".tp-4-preload-bottomright").length ||
      a(".tp-4-preload-left").length ||
      a(".tp-4-preload-right").length ||
      a(".tp-4-preload-top").length ||
      a(".tp-4-preload-bottom").length) &&
      a(".tp-loader-wrapper .tp-preload-reveal-layer-box")
        .css("width", b)
        .css("height", c)
        .css("transform", d)
