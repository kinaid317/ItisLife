  ...
  (b.prototype = {
    ...
    initFill: function () {
      function b() {
        ...
        (b.width = c.size),
          (b.height = c.size),
          b.getContext("2d").drawImage(o, 0, 0, f, f),
      ...
      if ((d.color && (this.arcFill = d.color), d.gradient)) {
        ...
        if (1 == g.length) this.arcFill = g[0];
          ...
          for (
            var h = d.gradientAngle || 0,
              j = d.gradientDirection || [
                (f / 2) * (1 - Math.cos(h)),
                (f / 2) * (1 + Math.sin(h)),
                (f / 2) * (1 + Math.cos(h)),
                (f / 2) * (1 - Math.sin(h)),
              ],
              k = e.createLinearGradient.apply(e, j),
              l = 0;
            l < g.length;
            l++
          ) {
      ...
      if (d.image) {
        var o;
        d.image instanceof Image
          ? (o = d.image)
          : ((o = new Image()), (o.src = d.image)),
          o.complete ? b() : (o.onload = b);
      }
    },
    draw: function () {
      this.animation
    ...
    drawArc: function (b) {
      ...
      c.save(),
        c.beginPath(),
        this.reverse
          ? c.arc(d, d, d - e / 2, f - 2 * Math.PI * b, f)
          : c.arc(d, d, d - e / 2, f, f + 2 * Math.PI * b),
        (c.lineWidth = e),
    ...
    drawEmptyArc: function (b) {
      ...
      1 > b &&
        ...
        c.beginPath(),
        0 >= b
          ? c.arc(d, d, d - e / 2, 0, 2 * Math.PI)
          : this.reverse
          ? c.arc(d, d, d - e / 2, f, f - 2 * Math.PI * b)
          : c.arc(d, d, d - e / 2, f + 2 * Math.PI * b, f),
        (c.lineWidth = e),
        (c.strokeStyle = this.emptyFill),
        c.stroke(),
        c.restore());
    },
    ...
    (a.circleProgress = { defaults: b.prototype }),
    ...
    (a.fn.circleProgress = function (c, d) {
      ...
      return this.each(function () {
        ...
        if (e) e.init(f);
          ...
          "string" == typeof g.fill && (g.fill = JSON.parse(g.fill)),
            "string" == typeof g.animation &&
              (g.animation = JSON.parse(g.animation)),
            (f = a.extend(g, f)),
            (f.el = d),
            (e = new b(f)),
            d.data("circle-progress", e);
        }
      });
    });
})(jQuery);
/*Progress Bar*/ (function (a) {
  "use strict";
  var b = function (a, c) {
    ...
    0 < b.length &&
      b.each(function () {
        ...
        a.waypoint(
          function (c) {
            "down" !== c ||
              a.hasClass("done-progress") ||
              (b.css("width", b.data("width")),
              a.find(".progress_bar-media.large") &&
                a
                  .find(".progress_bar-media.large")
                  .css("width", b.data("width")),
              a.addClass("done-progress"));
          },
          { offset: "90%" }
        );
      });
  ...
  a(window).on("elementor/frontend/init", function () {
    elementorFrontend.hooks.addAction(
      "frontend/element_ready/tp-progress-bar.default",
      b
    );
  });
})(jQuery);
